    ...
    <>
      ...
      <main className="flex flex-col justify-start gap-4 items-center flex basis-11/12 mx-5 my-10">
        ...
        <section className="flex flex-col gap-2 w-full">
          <div className="flex items-center gap-2"><div className="font-medium text-xs">Emergency Notifications</div><Image src="Ellipse.svg" className="max-w-1.5" alt="" width={112} height={112}/></div>
